...
# Node_number:观测站个数，至少4个
def forecast_3d(Node_number):
    # 参数设置
    Length=100
    Width=100
    Hight=100               #初始化场地
...
def plot_error_curve(start,end):
    ...
    plt.title('三维RSSI定位', fontdict={"size": 15})

    plt.show()

if __name__ == '__main__':
    # plot_error_curve(3, 20)   # 报错，三维定位观察站至少4个
    plot_error_curve(5,40)      # 观测站数5~39，从5开始是为了画图好看